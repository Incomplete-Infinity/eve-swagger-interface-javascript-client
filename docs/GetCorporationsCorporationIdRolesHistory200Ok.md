...
* `grantableRoles` (value: `"grantable_roles"`)

* `grantableRolesAtBase` (value: `"grantable_roles_at_base"`)

* `grantableRolesAtHq` (value: `"grantable_roles_at_hq"`)

* `grantableRolesAtOther` (value: `"grantable_roles_at_other"`)

* `roles` (value: `"roles"`)

* `rolesAtBase` (value: `"roles_at_base"`)

* `rolesAtHq` (value: `"roles_at_hq"`)
